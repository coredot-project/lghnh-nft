...
interface ERC721RoyaltyMockInterface extends ethers.utils.Interface {
  functions: {
...
export class ERC721RoyaltyMock extends Contract {
  ...
  interface: ERC721RoyaltyMockInterface;
  ...
  functions: {
    ...
    deleteDefaultRoyalty(overrides?: Overrides): Promise<ContractTransaction>;
  ...
  estimateGas: {
    ...
    deleteDefaultRoyalty(overrides?: Overrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    deleteDefaultRoyalty(overrides?: Overrides): Promise<PopulatedTransaction>;
