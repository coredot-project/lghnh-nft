...
interface Bytes32ToUintMapMockInterface extends ethers.utils.Interface {
  functions: {
    ...
    "set(bytes32,uint256)": FunctionFragment;
...
export class Bytes32ToUintMapMock extends Contract {
  ...
  interface: Bytes32ToUintMapMockInterface;
  ...
  "get(bytes32)"(key: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
