...
interface GovernorVoteMocksInterface extends ethers.utils.Interface {
  functions: {
...
export class GovernorVoteMocks extends Contract {
  ...
  interface: GovernorVoteMocksInterface;
