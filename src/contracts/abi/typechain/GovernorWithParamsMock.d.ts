...
interface GovernorWithParamsMockInterface extends ethers.utils.Interface {
  functions: {
  ...
  events: {
    "CountParams(uint256,string)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "CountParams"): EventFragment;
...
export class GovernorWithParamsMock extends Contract {
  ...
  interface: GovernorWithParamsMockInterface;
  ...
  filters: {
    CountParams(uintParam: null, strParam: null): EventFilter;
