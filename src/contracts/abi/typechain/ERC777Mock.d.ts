...
interface ERC777MockInterface extends ethers.utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    ...
    values: [string, BigNumberish, BytesLike, BytesLike, boolean]
  ): string;
...
export class ERC777Mock extends Contract {
  ...
  functions: {
    ...
    mintInternalExtended(
      ...
      userData: BytesLike,
      operatorData: BytesLike,
      requireReceptionAck: boolean,
      overrides?: Overrides
    ): Promise<ContractTransaction>;

    "mintInternalExtended(address,uint256,bytes,bytes,bool)"(
      to: string,
      amount: BigNumberish,
      userData: BytesLike,
      operatorData: BytesLike,
