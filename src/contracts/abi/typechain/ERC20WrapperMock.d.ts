...
export class ERC20WrapperMock extends Contract {
  ...
  recover(account: string, overrides?: Overrides): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    recover(account: string, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  estimateGas: {
    ...
    recover(account: string, overrides?: Overrides): Promise<BigNumber>;
