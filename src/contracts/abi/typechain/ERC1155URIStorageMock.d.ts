...
interface ERC1155URIStorageMockInterface extends ethers.utils.Interface {
  functions: {
...
export class ERC1155URIStorageMock extends Contract {
  ...
  interface: ERC1155URIStorageMockInterface;
