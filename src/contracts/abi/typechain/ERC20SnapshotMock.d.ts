...
interface ERC20SnapshotMockInterface extends ethers.utils.Interface {
  functions: {
...
export class ERC20SnapshotMock extends Contract {
  ...
  populateTransaction: {
    ...
    snapshot(overrides?: Overrides): Promise<PopulatedTransaction>;
